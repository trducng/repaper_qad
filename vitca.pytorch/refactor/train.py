...
from src.utils import norm_grad
from src.datasets import get_train_val_datasets
from src.model_and_trainer import ModelAndTrainer
...
if __name__ == "__main__":
    app = hydra.main(config_path="conf", config_name="train_config")(main)
    app()
